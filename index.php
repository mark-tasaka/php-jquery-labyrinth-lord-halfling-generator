...
<html>
<head>
<title>Launch Page: Labyrinth Lord Halfling Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="halflingForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2">
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#halflingForm").attr('action', "character/ll_halfling_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
